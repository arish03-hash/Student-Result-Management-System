...
try{
	...
	String q = "select * from student inner join result where student.rollNo = result.rollNo and student.rollNo='"+rollNo+"'";
...
Designed & Developed by Arish</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @Arish::2020-2024</h6></center> 
  <hr class="new1">
</body>
<%
}
